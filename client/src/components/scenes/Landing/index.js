	...
	return (
		<Fragment>
			...
			<div className='banner'>
				<h2>
					Software engineers of all levels coming together to sharpen
					their coding interview skills
				</h2>
			...
			<Container className='text-center'>
				<h3 className='subtitle'>
					What Happens At Whiteboard Warriors
				</h3>
				<Row className='mt-5 card-container'>
					<div className='info-card'>
						...
						<p>
							Pair up with another engineer of similar language
							and problem level. Each of you will take a turn for
							45 minutes.
						</p>
					</div>
					...
					<div className='info-card'>
						<img
							alt='icon'
							src='https://img.icons8.com/wired/100/000000/code.png'
						/>
						<h4>Improve Coding Skills</h4>
						<p>
							Practice makes perfect. At our War Time events you
							get to sharpen your coding skills with other
					...
					<div className='info-card'>
						<img
							alt='icon'
							src='https://img.icons8.com/wired/100/000000/meeting.png'
						/>
						<h4>Meet New People</h4>
						<p>
							They say "it's all about who you know". At the War
							Time events, you get the chance to meet people in
