const jobApplicationEmail = (employerName, applicantName, linkedIn) => {
	return `
	<body
		style="
			color: black;
										...
										>
											...
											>
												...
												<p
													...
													"
												>
													Here is a new job application from
													<b
														style="
															color: black;
															font-family: 'Roboto Slab', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto,
												...
												<p
													...
													"
												>
													Please click the button below to visit ${applicantName}'s LinkedIn profile.
												</p>
												<br
													style="
														color: black;
												...
												>
													...
													>
														REPLY</b
													>
													if you'd like to contact ${applicantName} or reach out via LinkedIn.
												</p>
												<br
													style="
														color: black;
